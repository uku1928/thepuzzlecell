                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: SizedBox(
                        width: 30.w,
                        child: Expander(
                          header: Text("Quick-Play", style: textStyle),
                          content: Column(
                            children: [
                ...
                ListView(
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          '${lang('infobox_scale', 'InfoBox Scale')}: ',
                          style: textStyle,
                        ),
                        SizedBox(
                          width: 20.w,
                          height: 5.h,
                          child: Slider(
                            value: storage.getDouble("infobox_scale")!,
                            min: 0.1,
                            max: 5,
                            divisions: 500,
                            onChanged: (v) => storage
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                          ...
                          height: 5.h,
                          child: Slider(
                            value: storage.getDouble("cell_scale")!,
                            min: 0.1,
                            max: 8,
                            divisions: 800,
                            onChanged: (v) => storage
                                ...
                                .then((v) => setState(() {})),
                            label: '${storage.getDouble('cell_scale')! * 100}%',
                          ),
                        ),
                      ],
                    ),
