...
var baseCellSize = 64.0;
var defaultCellSize = baseCellSize;
...
HashMap<String, String> textureMap = HashMap.from({
  ...
  "mech_rotator_cw.png": "mechanical/mech_rotator_cw.png",
  "mech_rotator_ccw.png": "mechanical/mech_rotator_ccw.png",
...
final cellInfo = <String, CellProfile>{
  ...
  "ungeneratable": CellProfile(
    "Ungeneratable",
    "Can't be generated by a generator or replicator",
  ),
  ...
  "master_rotate": CellProfile(
    "Rotate Cell",
    "Rotates the cell at master state's position, rotation amount is specified by the input number (n clockwise).",
  ),
};
...
class CellProperty {
  ...
  CellProperty(this.name, this.description, this.key, this.type, this.def);
}
...
Map<String, List<CellProperty>> props = {
  ...
  "electric_mover": [
    CellProperty(
      ...
      "Whether to draw power when it fails to move",
      "count_fails",
      CellPropertyType.boolean,
      false,
    ),
  ...
  "electric_battery": [
    ...
    CellProperty(
      "Capacity",
      "The maximum amount of power it can hold (only works if Use Capacity is on)",
      "capacity",
      CellPropertyType.number,
      100,
    ),
    CellProperty(
      "Cost",
      "Amount of power requried to power cells",
      "cost",
      CellPropertyType.number,
      1,
    ),
